...
/*Codigo del proyecto 2 funcional. Version 1.9.9
 *Ultima actualizacion realizada el 04/11/2022 a las 03:04am.
 *Se finalizo el menu y se configuraron las condiciones para el reinicio del juego una vez se determiene un ganador.
 *Se establecieron los ganadores y resetearon los puntajes.
 */
//***************************************************************************************************************************************
...
void loop() {
  ...
  if (mainMenu == 1){
    ...
    if (digitalRead(J2_Move) == LOW & select1 == 0){
    ...
    if (menu == 2){
      if (select1 == 0){
        ...
        if (digitalRead(start_PB) == LOW){
          ...
          select1 = 1;
          LCD_Clear(0x0000);
          LCD_BitmapSD(0, 0, 320, 240, "back.txt");
          FillRect((SCREEN_WIDTH/2) - 92 - SHIP_W, (SCREEN_HEIGHT/2) +16, SHIP_W, SHIP_H, 0x4229);
          LCD_Print("P1", 30+SHIP_W+(5*SHIP_W+50)+32, 75, 2, 0xFFFF, 0x4229);
          LCD_Bitmap(30+SHIP_W, 70, SHIP_W, SHIP_H, nave_naranja);
          LCD_Bitmap(30+SHIP_W+(1*SHIP_W+10), 70, SHIP_W, SHIP_H, nave_azul);
          LCD_Bitmap(30+SHIP_W+(2*SHIP_W+20), 70, SHIP_W, SHIP_H, nave_amarilla);
          LCD_Bitmap(30+SHIP_W+(3*SHIP_W+30), 70, SHIP_W, SHIP_H, nave_aqua);
          LCD_Bitmap(30+SHIP_W+(4*SHIP_W+40), 70, SHIP_W, SHIP_H, nave_morada);
          LCD_Bitmap(30+SHIP_W+(5*SHIP_W+50), 70, SHIP_W, SHIP_H, nave_verde);  
          LCD_Print("P2", SCREEN_WIDTH-40-SHIP_W-(5*SHIP_W+50)-52, SCREEN_HEIGHT-65, 2, 0xFFFF, 0x4229);
          LCD_Bitmap(SCREEN_WIDTH-40-SHIP_W, SCREEN_HEIGHT-70, SHIP_W, SHIP_H, nave_naranja);
          LCD_Bitmap(SCREEN_WIDTH-40-SHIP_W-(1*SHIP_W+10), SCREEN_HEIGHT-70, SHIP_W, SHIP_H, nave_azul);
          LCD_Bitmap(SCREEN_WIDTH-40-SHIP_W-(2*SHIP_W+20), SCREEN_HEIGHT-70, SHIP_W, SHIP_H, nave_amarilla);
          LCD_Bitmap(SCREEN_WIDTH-40-SHIP_W-(3*SHIP_W+30), SCREEN_HEIGHT-70, SHIP_W, SHIP_H, nave_aqua);
          LCD_Bitmap(SCREEN_WIDTH-40-SHIP_W-(4*SHIP_W+40), SCREEN_HEIGHT-70, SHIP_W, SHIP_H, nave_morada);
          LCD_Bitmap(SCREEN_WIDTH-40-SHIP_W-(5*SHIP_W+50), SCREEN_HEIGHT-70, SHIP_W, SHIP_H, nave_verde); 
        }
      }
      if (select1 == 1){
        playerShipSelect();
  ...
  if(num_aliens_destroyed == 20){
    ...
    if (level > 2 & player1_final_score > player2_final_score){
      LCD_Clear(0x0000);
      LCD_BitmapSD(0, 0, 320, 240, "win1.txt");
      delay(5000);
      level = 0;
      ...
      LCD_Clear(0x0000);
      LCD_BitmapSD(0, 0, 320, 240, "win2.txt");
      delay(5000);
      level = 0;
      num_aliens_destroyed = 0;
      player1_final_score = 0;
      ...
      LCD_Clear(0x0000);
      LCD_BitmapSD(0, 0, 320, 240, "empate.txt");
      delay(5000);
      level = 0;
      num_aliens_destroyed = 0;
      player1_final_score = 0;
...
void playerShipSelect(void){
  ...
  switch (ship_select1){
    case 0:
      Rect(30+SHIP_W+(5*SHIP_W+50), 70, SHIP_W, SHIP_H, 0x4229);
      Rect(30+SHIP_W, 70, SHIP_W, SHIP_H, 0xFFFF);
      break;
    case 1:
      Rect(30+SHIP_W, 70, SHIP_W, SHIP_H, 0x4229);
      Rect(30+SHIP_W+(1*SHIP_W+10), 70, SHIP_W, SHIP_H, 0x4229);
      break;
    case 2:
      Rect(30+SHIP_W+(1*SHIP_W+10), 70, SHIP_W, SHIP_H, 0x4229);
      Rect(30+SHIP_W+(2*SHIP_W+20), 70, SHIP_W, SHIP_H, 0xFFFF);
      break;
    case 3:
      Rect(30+SHIP_W+(2*SHIP_W+20), 70, SHIP_W, SHIP_H, 0x4229);
      Rect(30+SHIP_W+(3*SHIP_W+30), 70, SHIP_W, SHIP_H, 0xFFFF);
      break;
    case 4:
      Rect(30+SHIP_W+(3*SHIP_W+30), 70, SHIP_W, SHIP_H, 0x4229);
      Rect(30+SHIP_W+(4*SHIP_W+40), 70, SHIP_W, SHIP_H, 0xFFFF);
      break;
    case 5:
      Rect(30+SHIP_W+(4*SHIP_W+40), 70, SHIP_W, SHIP_H, 0x4229);
      Rect(30+SHIP_W+(5*SHIP_W+50), 70, SHIP_W, SHIP_H, 0xFFFF);
      break;
  }
  switch (ship_select2){
    case 0:
      Rect(SCREEN_WIDTH-40-SHIP_W-(5*SHIP_W+50), SCREEN_HEIGHT-70, SHIP_W, SHIP_H, 0x4229);
      Rect(SCREEN_WIDTH-40-SHIP_W, SCREEN_HEIGHT-70, SHIP_W, SHIP_H, 0xFFFF);
      break;
    case 1:
      Rect(SCREEN_WIDTH-40-SHIP_W, SCREEN_HEIGHT-70, SHIP_W, SHIP_H, 0x4229);
      Rect(SCREEN_WIDTH-40-SHIP_W-(1*SHIP_W+10), SCREEN_HEIGHT-70, SHIP_W, SHIP_H, 0xFFFF);
      break;
    case 2:
      Rect(SCREEN_WIDTH-40-SHIP_W-(1*SHIP_W+10), SCREEN_HEIGHT-70, SHIP_W, SHIP_H, 0x4229);
      Rect(SCREEN_WIDTH-40-SHIP_W-(2*SHIP_W+20), SCREEN_HEIGHT-70, SHIP_W, SHIP_H, 0xFFFF);
      break;
    case 3:
      Rect(SCREEN_WIDTH-40-SHIP_W-(2*SHIP_W+20), SCREEN_HEIGHT-70, SHIP_W, SHIP_H, 0x4229);
      Rect(SCREEN_WIDTH-40-SHIP_W-(3*SHIP_W+30), SCREEN_HEIGHT-70, SHIP_W, SHIP_H, 0xFFFF);
      break;
    case 4:
      Rect(SCREEN_WIDTH-40-SHIP_W-(3*SHIP_W+30), SCREEN_HEIGHT-70, SHIP_W, SHIP_H, 0x4229);
      Rect(SCREEN_WIDTH-40-SHIP_W-(4*SHIP_W+40), SCREEN_HEIGHT-70, SHIP_W, SHIP_H, 0xFFFF);
      break;
    case 5:
      Rect(SCREEN_WIDTH-40-SHIP_W-(4*SHIP_W+40), SCREEN_HEIGHT-70, SHIP_W, SHIP_H, 0x4229);
      Rect(SCREEN_WIDTH-40-SHIP_W-(5*SHIP_W+50), SCREEN_HEIGHT-70, SHIP_W, SHIP_H, 0xFFFF);
      break;
  }
}
...
void nextLevel(void){
  switch(level){
    case 1:
      LCD_BitmapSD(0, 0, 320, 240, "cambio.txt");
      LCD_Print("ROUND2", 68, 140, 2, 0xFFFF, 0x0000);
      break;
    case 2:
      LCD_BitmapSD(0, 0, 320, 240, "cambio.txt");
