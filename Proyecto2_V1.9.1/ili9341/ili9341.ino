...
#define X_START_OFFSET 34 // POSICION DE SEPARACIÓN ENTRE BORDE DE PANTALLA Y ALIEN
...
void posControl(void){
  ...
  if ((currentMillis3 - previousMillis3) > 1000 & (currentMillis3 - previousMillis3) < 2005){
    moveByXAmount1 = 1;
    moveByXAmount2 = 1;
    moveByXAmount3 = 1;
    digitalWrite(6, HIGH);
  }
  else if((currentMillis4 - previousMillis4) >= 2000 & (currentMillis4 - previousMillis4) < 20000){
    moveByXAmount1 = -1;
    moveByXAmount2 = -1;
    moveByXAmount3 = -1;
    digitalWrite(6, LOW);    
