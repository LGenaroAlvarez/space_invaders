//PROYECTO 2 ELECTRONICA DIGITAL 2
...
#define MISSILE_SPEED 5       // A menor valor mayor velocidad
...
#define ALIEN_COLUMN_QTY 5    // 
#define ALIEN_ROW_QTY 3       // 
...
int ship1_pos_X = 0;    // Posición X de nave1
int ship1_pos_Y = 240;  // Posición Y de nave1
int ship2_pos_X = 0;    // Posición X de nave2
int ship2_pos_Y = 240;  // Posición Y de nave2
int x = 0;              // Posición inicial en X de nave1
int x1 = 160;           // Posición inicial en X de nave2
...
void checkColissions(void);
void missileHitAlien(void);
...
void loop() {
  ...
  estado3 = digitalRead(8);
  estado4 = digitalRead(9);
  estado5 = digitalRead(10);
  estado6 = digitalRead(11);
  // PRESIÓN DE BOTONES
  movePlayers();
...
void fireMissiles(void){
  ...
  if(estado5 == LOW & estado6 == LOW){
    ...
    else if(missile_status == ACTIVE & missile_status2 == DESTROYED2){
      missile2_pos_X = ship2_pos_X + (SHIP_W/2);
      missile2_pos_Y = ship2_pos_Y - MISSILE_H;
      missile_status2 = ACTIVE2;
    }
    else if(missile_status == DESTROYED & missile_status2 == ACTIVE2){
      missile1_pos_X = ship1_pos_X + (SHIP_W/2);
      missile1_pos_Y = ship1_pos_Y - MISSILE_H;
      missile_status = ACTIVE;
    }
...
void missileControl(void){  
  if (missile_status == ACTIVE){
    speed_1 -= MISSILE_SPEED;
    if(speed_1 = 0){
      speed_1 = 5;
      missile1_pos_Y -= MISSILE_SPEED;
      if(missile1_pos_Y >= 0){
...
//void missileHitAlien(void){
//  for(int leftRight = 0; leftRight<ALIEN_COLUMN_QTY; leftRight++){
//    for(int upDown = 0; upDown<ALIEN_ROW_QTY; upDown++){
//      if(){
//        if(){
//          if(){
//            
